...
app.py — Entrypoint principal (Streamlit ≥ 1.36 — st.navigation com funções)

IMPORTANTE: renomear este arquivo para app.py no repositório.
...
# ═══════════════════════════════════════════════════════════════════════════════
def pagina_sinais():
    import pages.sinais_e_sistemas_lineares as m; m  # noqa — executa o módulo

def pagina_laplace():
    import pages.transformada_de_laplace as m; m  # noqa

def pagina_ord1():
    import pages.dinamica_sistemas_ordem_1 as m; m  # noqa

def pagina_ord2():
    import pages.dinamica_sistemas_ordem_2 as m; m  # noqa

def pagina_mf():
    import pages.realimentacao_malha_fechada as m; m  # noqa

def pagina_lgr():
    import pages.realimentacao_lgr as m; m  # noqa

def pagina_estab():
    import pages.estabilidade_realimentacao as m; m  # noqa

def pagina_bode():
    import pages.resposta_frequencia as m; m  # noqa

def pagina_nyquist():
    import pages.criterio_nyquist as m; m  # noqa

def pagina_ss():
    import pages.espaco_de_estados as m; m  # noqa
